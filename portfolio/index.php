...
<html lang="fr">
  ...
  <body>
    ...
    <section class="accueil"> <!-- Section générale, page accueil-->
      <section> <!-- Section Logo + slogan -->
              ...
              <img src="images/logowisna_definitif.png" alt="Notre beau logo !" > <!-- insertion du logo Wisna sur la 1ère page -->
                <div class="slogan">
                  <h1>A la conquête du quotidien  !</h1>
                    <hr>
                    <!-- insertion du slogan en dessous du logo -->
                    <div class="bouton_entrer">
                    </div>
                  </div>
                </div>
            </div>
        </section> <!-- fermeture de la section logo + slogan -->
          <section > <!-- Section 2, actions de Wisna -->
            <div class="liste">
              <h2>Nos propositions : </h2><br/>
                  <p>Domotique</p>
                  <p>Art numérique</p>
                  <p>Objets connectés</p><br/>
                    <button href="#projets" type="button" class="btn btn-success btn-lg">Découvrez-nous !</button>
            </div>
          <hr>
    </section> <!-- Fermeture de la section actions de Wisna -->
  </section> <!-- Fermeture de la section générale - page d'accueil -->
...
<!-- Fin de la première page du site -->
      ...
      <article id="quiSommesNous"> <!-- Page Qui sommes nous -->
        <h1> Qui sommes-nous ? </h1>
          <div class="raw">
            <div class="col-md-4"><img src="images/julienc.jpg"><h3>Julien C</h3></div>
            <div class="col-md-4"><img src="images/julienc.jpg"><h3>Julien C</h3></div>
            <div class="col-md-4"><img src="images/julienc.jpg"><h3>Julien C</h3></div>
          </div>
            <hr>
